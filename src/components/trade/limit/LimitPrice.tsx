      ...
      <NumberInput
        ...
        rightSection={
          <Button
            ...
            aria-label={`Reset ${label} to market`}
          >
            Set to Market
          </Button>
        }
        ...
        classNames={{
          ...
          input: "text-right text-purple pr-3 rounded-2xl text-xl sm:text-3xl border-0 focus:ring-0 focus:border-0 md:min-h-20 bg-transparent relative z-10",
        }}
      />
    </div>
  );
